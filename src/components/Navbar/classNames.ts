...
export const NavbarStyles = {
  ...
  sideDiv: clx(
    "absolute z-40 top-0 left-0 bg-white max-w-[300px] w-full rounded-tr-xl rounded-br-xl  h-screen transition-translate duration-500 ease-in-out  py-4 overflow-hidden"
  ),
  SideBarLinks: clx(
